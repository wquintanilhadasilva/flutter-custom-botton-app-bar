...
class CustomBottonAppBar extends StatefulWidget {

  final ValueChanged<int> onTabSelected;
  final List<CustomAppBarItem> items;

  CustomBottonAppBar({this.onTabSelected, this.items}) {
    assert(this.items.length ==2 || this.items.length == 4);
  }

  @override
  _CustomBottonAppBarState createState() => _CustomBottonAppBarState();
}

class _CustomBottonAppBarState extends State<CustomBottonAppBar> {
              ...
              ?
                Stack(
                  ...
                  children: [
                    Icon(
                      item.icon,
                      color: _selectedIndex == index ? Colors.blue[900] : Colors.grey,
                      size: 24.0,
                    ),
                    Positioned(
                      top: 16.0,
